...
const MetodoPForm = ({ isEdit, initialData, setShowModal, showModal }) => {

    const dispatch = useDispatch();

    const {loading, saveLoading ,formError} = useSelector((store) => store.metodoPago);
    ...
    const onSubmit = (data) => {
        ...
        if (isEdit) {
            ...
            console.log(data)
            dispatch(editMetodoPago(data,initialData.data.id_metodo_pago,initialData.index,setShowModal))
            
        } else {
            data.creado_por = user
            console.log(data)
            dispatch(saveMetodoPago(data,setShowModal))
        }
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit(onSubmit)}>
                <DialogTitle>
                    {isEdit ? 'Editar método de pago' : 'Añada un método de pago'}
                </DialogTitle>
