...
// api
import { getUsuario, deleteUsuario } from "../../../../../redux/mantenimientos/usuario/actions";
  ...
  const handleDelete = (data, index) => {
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          data.estado = false;
          dispatch(deleteUsuario(data.id, index));
        }
      });
  };
  ...
  return (
    <DashboardLayout>
      <Fondo>
        ...
        <BoxButton>
          {usuarioError && <Alert severity="error">{usuarioError}</Alert>}
        ...
        <UsuarioForm initialData={editItem} isEdit={isEdit} setShowModal={setShowModal} showModal={showModal} />
