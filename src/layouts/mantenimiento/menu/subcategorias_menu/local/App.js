...
import { BODEGA_PRINCIPAL, PERMISOS } from "../../../../../services/constantes";
...
const app = () => {
  ...
  const columns = useMemo(() => [
    ...
    { accessorKey: 'codigo_establecimiento', header: 'Cod. Establecimiento'},
    ...
    },
    {
      ...
      Cell: ({ row }) => {
        ...
        // Verifica si el correlativo del local está en los tipos permitidos
        const isInNoEditables = row.original.correlativo_venta == BODEGA_PRINCIPAL
        return (
          !isInNoEditables && (
